            ...
            LazyColumn(
                ...
                items(equipos) { equipo ->
                    EquipoCard(
                        ...
                        favoritosViewModel = favoritosViewModel // Pasar favoritosViewModel aquí
                    )
...
fun PantallaFavoritos(
    ...
    Column(
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(equiposFavoritos) { equipo ->
                    ...
                    EquipoCard(
                        equipo = equipo,
                        onFavoriteClick = { /* Lógica de manejo de clics en el icono de favoritos */ },
                        favoritosViewModel = favoritosViewModel // Pasar el ViewModel aquí
                    )
                    Spacer(modifier = Modifier.height(8.dp)) // Agrega espacio entre tarjetas
                }
            }
        ...
        // Barra de navegación
        // Similar a la barra de navegación de la pantalla de la Liga Americana
    }
}
...
fun EquipoCard(
    ...
    // Uso de rememberUpdatedState para actualizar el estado del componente cuando cambia el estado de equipo.esFavorito
    var esFavorito by remember { mutableStateOf(equipo.esFavorito.value) }
    ...
    Card(
        ...
        Box(
            ...
            Box(
                ...
                IconButton(
                    onClick = {
                        ...
                        // Actualizar el estado del componente después de cambiar el estado del equipo favorito
            ...
            // Icono de eliminar en la esquina inferior derecha
            IconButton(
